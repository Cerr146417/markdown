...
![](media/a05c6872161196dd74c92ee707c731e3.png)

### 1.2.2 计算机系统组成

![](media/35c57895fb51282e53ee17eff3ff6468.png)
...
![](media/65818ca8c9c8a7e91f427c61e7f6d7b5.jpg)
...
![](media/ba479083170370b96d82d6c2fd74094c.jpg)
...
-   main函数是操作系统调用的，第一个参数标明argv数组的成员数量，argv数组的每个成员都是char
    \*类型
...
extern int
a;声明一个变量，这个变量在别的文件中已经定义了，这里只是声明，而不是定义。
